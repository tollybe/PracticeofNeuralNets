...
class MyWidget(QtGui.QMainWindow, form_class):
    ...
    def win(self):  # Display a dialog if player wins
        QtGui.QMessageBox.information(self, "Hangman", "You win! Take off an item from partners clothes")  #
        self.new_game()  #
    ...
    def wrong(self):
        ...
        if self.pieces_shown == len(self.pieces):
            message = "You lose. Please remove an article of clothing  The word was " + self.currentword  # Player lost
